...
{
    public class UdtUpdateAkzoPodToDb : SqlDataRecord
    {
        public UdtUpdateAkzoPodToDb(UpdateAKZOPod pod)
            : base(s_metadata)
        {
            ...
            SetSqlString(7, pod.CustomerAccount);
        }
        ...
        private static readonly SqlMetaData[] s_metadata =
        {
            ...
            new SqlMetaData("CustomerAccount",SqlDbType.NVarChar,50)

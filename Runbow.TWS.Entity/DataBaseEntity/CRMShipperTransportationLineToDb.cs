...
{
    public class CRMShipperTransportationLineToDb : SqlDataRecord
    {
        public CRMShipperTransportationLineToDb(CRMShipperTransportationLine shipperTransportationLine)
            : base(s_metadata)
        {

...
namespace Runbow.TWS.Entity
{
    ...
    public class AdjustmentDetail
    {
        ...
        [EntityPropertyExtension("AID", "AID")]
        public int AID { get; set; }

        [EntityPropertyExtension("Manufacturer", "Manufacturer")]
        public string Manufacturer { get; set; }

        [EntityPropertyExtension("AdjustmentNumber", "AdjustmentNumber")]
        ...
        [EntityPropertyExtension("FromLot", "FromLot")]
        public string FromLot { get; set; }

        [EntityPropertyExtension("ToLot", "ToLot")]
        ...
        [EntityPropertyExtension("BoxNumberNew", "BoxNumberNew")]
        public string BoxNumberNew { get; set; }
        ...
        [EntityPropertyExtension("AdjustmentReason", "AdjustmentReason")]
        public string AdjustmentReason { get; set; }

        [EntityPropertyExtension("IsHold", "IsHold")]

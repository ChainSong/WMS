...
namespace Runbow.TWS.Entity
{
    ...
    public class ReportStaff
    {
        ...
        /// 创建人
        /// </summary>
        [EntityPropertyExtension("StaffName", "StaffName")]
        ...
        [EntityPropertyExtension("OperatingPlatform", "OperatingPlatform")]
        public string OperatingPlatform { get; set; }

        [EntityPropertyExtension("OperationContent", "OperationContent")]

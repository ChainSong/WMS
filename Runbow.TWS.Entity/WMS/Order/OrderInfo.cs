...
namespace Runbow.TWS.Entity
{
    public class OrderInfo
    {
        ...
        [EntityPropertyExtension("IsMerged", "IsMerged")]
        public int? IsMerged { get; set; }

        [EntityPropertyExtension("MergeNumber", "MergeNumber")]
        ...
        [EntityPropertyExtension("ExpressStatus", "ExpressStatus")]
        public int? ExpressStatus { get; set; }

        [EntityPropertyExtension("PickPrintCount", "PickPrintCount")]
        public int? PickPrintCount { get; set; }

        [EntityPropertyExtension("ExpressPrintCount", "ExpressPrintCount")]
        public int? ExpressPrintCount { get; set; }

        [EntityPropertyExtension("PodPrintCount", "PodPrintCount")]
        public int? PodPrintCount { get; set; }

        [EntityPropertyExtension("OtherPrintCount", "OtherPrintCount")]
        public int? OtherPrintCount { get; set; }
        ...
        /// 门店属性
        /// </summary>
        [EntityPropertyExtension("StorerType", "StorerType")]
        public string StorerType { get; set; }

...
namespace Runbow.TWS.Entity 
{
    public class ProductDetail
    {
        ...
        [EntityPropertyExtension("PID", "PID")]
        ...
        [EntityPropertyExtension("UPCName", "UPCName")]
        public string UPCName { get; set; }

        [EntityPropertyExtension("UPCType", "UPCType")]
        public string UPCType { get; set; }

        [EntityPropertyExtension("UPCNumber", "UPCNumber")]

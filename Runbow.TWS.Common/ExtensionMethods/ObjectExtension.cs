...
namespace Runbow.TWS.Common
{
    public static class ObjectExtension
    {
        ...
        public static string ObjectToString2(this object obj)
        {
        ...
        public static string YearMonthDayHHMMSS(this DateTime t)
        {
        ...
        /// <returns>输出</returns>
        public static string GetHidexxxString(this string Input)
        {
            string Output = "";
            switch (Input.Length)
            {

...
namespace CSRedis {
	public partial class CSRedisClient : IDisposable {
		...
		public object SerializeRedisValueInternal(object value) {
		...
		public T DeserializeRedisValueInternal<T>(byte[] value) {
		...
		#region 分区方式 Execute
		public T ExecuteScalar<T>(string key, Func<Object<RedisClient>, string, T> hander) {
		...
		public long ExecuteNonQuery(string[] key, Func<Object<RedisClient>, string[], long> hander) {

...
{
    public class DefaultNikeTestAllocate : BaseAllocate
    {
        public DefaultNikeTestAllocate(string AllocateMode, string AllocateType, long ID, string CustomerId,
        ...
        public override void CustomerDefinedSettledAllocate()
        {
            ...
            {
                this.SqlProc = "Proc_WMS_AutomatedOutbound_Nike_Test";

...
{
    public class DefaultYXDRBJAllocate : BaseAllocate
    {

        public DefaultYXDRBJAllocate(string AllocateMode, string AllocateType, long ID, string CustomerId,
        ...
        public override void CustomerDefinedSettledAllocate()
        {
            ...
            {
                this.SqlProc = "Proc_WMS_AutomatedOutbound_YXDRBJ";

...
{
    public class DefaultAKZOJSAllocate : BaseAllocate
    {
        public DefaultAKZOJSAllocate(string AllocateMode, string AllocateType, long ID, string CustomerId,
        ...
        public override void CustomerDefinedSettledAllocate()
        {
            ...
            {
                this.SqlProc = "Proc_WMS_AutomatedOutbound_AKZOJS_" + CustomerId;

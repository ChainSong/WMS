...
{
    public class DefaultAKZOAllocate : BaseAllocate
    {
        public DefaultAKZOAllocate(string AllocateMode, string AllocateType, long ID, string CustomerId,
        ...
        public override void CustomerDefinedSettledAllocate()
        {
            ...
            {
                this.SqlProc = "Proc_WMS_AutomatedOutbound_AKZO_" + CustomerId;
            ...
            { 
                ...
                this.SqlProc = "Proc_WMS_AssignedOutbound_AKZO_" + CustomerId;
                PreOrderService service = new PreOrderService();
            ...
            {
                this.SqlProc = "Proc_WMS_ManualAllocation_AKZO_" + CustomerId;
                PreOrderService service = new PreOrderService();
                var response = service.ManualAllocationJson(new ManualAllocationRequest() { PodRequest = Pod, ID = ID, CustomerId = CustomerId, Creator = UserName, Criterion = AllocateType, SqlProc = SqlProc });
                if (!response.IsSuccess)
                {

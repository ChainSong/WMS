...
namespace Runbow.TWS.Web.Areas.WMS.Controllers
{
    public class ASNManagementSFController : BaseController
    {
        ...
        public ActionResult ASNCreateOrEdit(int ID, long? customerID, int ViewType = 0)
        {
            ...
            var UnitAndSpecificationsList = ApplicationConfigHelper.GetWMS_UnitAndSpecifications_Config(base.UserInfo.ProjectID, vm.ASNCondition.CustomerID, vm.ASNCondition.WarehouseID);
        ...
        // 0查看 1新增 2编辑
        [HttpGet]
        public ActionResult ASNCreateOrEditSF(int ID, long? customerID, int ViewType = 0)
        {
            IndexViewModel vm = new IndexViewModel();
            #region ASNType赋值
            IEnumerable<WMSConfig> wms = null;
        ...
        //新增
        [HttpPost]
        public string AddASNAndASNDetailsSF(string JsonTable, string ExternReceiptNumber, string CustomerName, int CustomerID, string ASNType, string Remark, int WarehouseID, string Warehousename, DateTime ExpectDate, string JsonField)
        {
        ...
        //编辑
        [HttpPost]
        public string UpdateASNAndASNDetailsSF(string JsonTable, int ID, string ExternReceiptNumber, string CustomerName, int CustomerID, string ASNType, string Remark, int WarehouseID, string Warehousename, DateTime ExpectDate, DateTime Createtime, string Creator, string ASNNumber, string JsonField)
        {
            IEnumerable<Column> columns;
            var project = ApplicationConfigHelper.GetApplicationConfigNew(base.UserInfo.ProjectID, CustomerID).ProjectCollection.First();
            Runbow.TWS.Entity.Module module = project.ModuleCollection.First(m => m.Id == "M002");

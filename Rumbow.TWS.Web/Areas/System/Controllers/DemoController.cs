...
namespace Runbow.TWS.Web.Areas.System.Controllers
{
    public class DemoController : BaseController
    {
        ...
        public string ExcelInput()
        {
            if (Request.Files.Count > 0)
            {
                ...
                if (hpf.ContentLength > 0)
                {
                    ...
                    string targetPath = Path.Combine(uploadFolderPath, base.UserInfo.ProjectID.ToString(), "Temp");
                    ...
                    if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        return ds.Tables[0].ConvertToEntityCollection<Runbow.TWS.Entity.User>().ToJsonString();
                    }
                }
            }
        ...
        public ActionResult GetData()
        {
            ...
            {
                new Map(){CenterLat = 112.3579643582M, CenterLng=31.1376622409M,Zoom=8,Title="上海物流科技有限公司"},
                new Map(){ CenterLat=116.5588026064M, CenterLng=39.857843146M, Zoom=8,Title="北京"}
            };

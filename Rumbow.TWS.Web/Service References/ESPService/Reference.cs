...
namespace Runbow.TWS.Web.ESPService {
    ...
    public interface ESPServiceSoap {
        ...
        Runbow.TWS.Web.ESPService.AddEmailSendingResponse AddEmailSending(Runbow.TWS.Web.ESPService.AddEmailSendingRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddEmailSending", ReplyAction="*")]
        System.Threading.Tasks.Task<Runbow.TWS.Web.ESPService.AddEmailSendingResponse> AddEmailSendingAsync(Runbow.TWS.Web.ESPService.AddEmailSendingRequest request);
    }
    ...
    public partial class AddEmailSendingRequest {
        ...
        public Runbow.TWS.Web.ESPService.AddEmailSendingRequestBody Body;
        
        public AddEmailSendingRequest() {
        }
        
        public AddEmailSendingRequest(Runbow.TWS.Web.ESPService.AddEmailSendingRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class AddEmailSendingRequestBody {
        ...
        public Runbow.TWS.Web.ESPService.EmailSending EmailSending;
        
        public AddEmailSendingRequestBody() {
        }
        
        public AddEmailSendingRequestBody(Runbow.TWS.Web.ESPService.EmailSending EmailSending) {
    ...
    public partial class AddEmailSendingResponse {
        ...
        public Runbow.TWS.Web.ESPService.AddEmailSendingResponseBody Body;
        
        public AddEmailSendingResponse() {
        }
        
        public AddEmailSendingResponse(Runbow.TWS.Web.ESPService.AddEmailSendingResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ESPServiceSoapChannel : Runbow.TWS.Web.ESPService.ESPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ESPServiceSoapClient : System.ServiceModel.ClientBase<Runbow.TWS.Web.ESPService.ESPServiceSoap>, Runbow.TWS.Web.ESPService.ESPServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Runbow.TWS.Web.ESPService.AddEmailSendingResponse Runbow.TWS.Web.ESPService.ESPServiceSoap.AddEmailSending(Runbow.TWS.Web.ESPService.AddEmailSendingRequest request) {
            return base.Channel.AddEmailSending(request);
        }
        
        public bool AddEmailSending(Runbow.TWS.Web.ESPService.EmailSending EmailSending) {
            Runbow.TWS.Web.ESPService.AddEmailSendingRequest inValue = new Runbow.TWS.Web.ESPService.AddEmailSendingRequest();
            inValue.Body = new Runbow.TWS.Web.ESPService.AddEmailSendingRequestBody();
            inValue.Body.EmailSending = EmailSending;
            Runbow.TWS.Web.ESPService.AddEmailSendingResponse retVal = ((Runbow.TWS.Web.ESPService.ESPServiceSoap)(this)).AddEmailSending(inValue);
            return retVal.Body.AddEmailSendingResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Runbow.TWS.Web.ESPService.AddEmailSendingResponse> Runbow.TWS.Web.ESPService.ESPServiceSoap.AddEmailSendingAsync(Runbow.TWS.Web.ESPService.AddEmailSendingRequest request) {
            return base.Channel.AddEmailSendingAsync(request);
        }
        
        public System.Threading.Tasks.Task<Runbow.TWS.Web.ESPService.AddEmailSendingResponse> AddEmailSendingAsync(Runbow.TWS.Web.ESPService.EmailSending EmailSending) {
            Runbow.TWS.Web.ESPService.AddEmailSendingRequest inValue = new Runbow.TWS.Web.ESPService.AddEmailSendingRequest();
            inValue.Body = new Runbow.TWS.Web.ESPService.AddEmailSendingRequestBody();
            inValue.Body.EmailSending = EmailSending;
            return ((Runbow.TWS.Web.ESPService.ESPServiceSoap)(this)).AddEmailSendingAsync(inValue);
        }
    }
}

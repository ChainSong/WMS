$(document).ready(function () {
    ...
    $('#printButton').live('click', function () {
        ...
        //}
        //else {
        //    window.location.href = '/WMS/OrderManagement/PrintOrder?id=' + id;
        //}
...
function Package() {
    if ($("#ProjectName").val() == "NIKE" || $("#ProjectName").val() == "YXDR") {
        location.href = "/WMS/OrderManagement/YXDRPackage/?ID=" + +$("#order_ID").val()
    }
    else {
        location.href = "/WMS/OrderManagement/Package/?ID=" + +$("#order_ID").val()
    }
}
function Handover() {

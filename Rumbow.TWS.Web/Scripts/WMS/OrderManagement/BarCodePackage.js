...
$(document).ready(function () {
    ...
    $("#submitButton").live('click', function () {
        ...
        if (flag == 0) {
            $.ajax({
                type: "Post",
                url: "/WMS/OrderManagement/BarCodePackage",
                data: {
                    "ID": $("#OrderID").val(),
                ...
                success: function (data) {
                    if (data == "") {
                        ...
                        showMsg("保存成功！", 4000);
                        location.href = "/WMS/OrderManagement/BarCodePackage/?ID=" + $("#OrderID").val();
                    }
                    else {
    ...
    $("#ScanSKU").live('keydown', function () {
        if (event.keyCode == 13) {
            ...
            if (list_json.length==0) {
                $.post("/WMS/OrderManagement/GetSKUAndBarCodeByBarCode", { BarCode: inputsku.val() }, function (result) {
                    if (result.length > 0) {
...
function printboxDiv(id, type, OrderID) {
    ...
    //$.ajax({
    //    type: "Post",
    //    url: "/WMS/OrderManagement/printbox",
    //    data: {
    //        "ID": id,
    //        "type": type
    //    },
...
function printboxmDiv(id, type, OrderID) {
    ...
    //$.ajax({
    //    type: "Post",
    //    url: "/WMS/OrderManagement/printboxm",
    //    data: {
    //        "ID": id,
    //        "type": type
    //    },

...
$(document).ready(function () {
    ...
    $("#OrderSend").live('click', function () {
        ...
        layer.confirm('<font size="4">确认是否批量推送出库单？</font>', {
            ...
            $.ajax({
                url: "/WMS/OrderManagementFG/OrderSend",
                type: "POST",
                dataType: "json",
                data: {
    ...
    $("#OrderConfirmSend").live('click', function () {
        ...
        layer.confirm('<font size="4">确认是否批量推送出库确认？</font>', {
            ...
            $.ajax({
                url: "/WMS/OrderManagementFG/OrderOutConfirm",
                type: "POST",
                dataType: "json",
                data: {
                    JCRequestList: jsonStr
    ...
    $('#OrderTask').live('click', function () {
        layer.confirm('<font size="4">确认是否下发任务？</font>', {
            ...
            if (id == "") {
                ...
                $.ajax({
                    type: "Post",
                    url: "/WMS/OrderManagementFG/OrderTask",
                    data: {
                        "ID": id
                    },
                    async: "false",
    ...
    $('#ExportDiffButton').live('click', function () {
        ...
        if (id == "") {
            ...
            window.location.href = "/WMS/OrderManagementFG/CheckDiffBatch?ids=" + id
        }
    });
            ...
            if (id == "") {
                ...
                if ($("#ProjectName").val() == "EWE") {
                    ...
                    if (ordertypeArr[0] == "B2B") {
                        ...
                        window.location.href = '/WMS/OrderManagementFG/PrintOrderNikeB2CSFS?id=' + id + "&Flag=1";
                    } else if (ordertypeArr[0] == "B2CSTH") {
                        window.location.href = '/WMS/OrderManagementFG/PrintOrderNikeB2CSTH?id=' + id + "&Flag=1";
                    }
                    //if (ordertypeArr.length > 1) {
                    //    showMsg("B2B订单和B2C订单不能同时打印，请检查！", 3000);
                    //    return false;
                    ...
                    //    window.location.href = '/WMS/OrderManagementFG/PrintOrderNike?id=' + id + "&Flag=1";
                    //} else {
                    //    window.location.href = '/WMS/OrderManagementFG/PrintOrderNikeB2C?id=' + id + "&Flag=1";
                    //}
                }
    ...
    $("#printExpButton").click(function () {
        ...
        window.location.href = '/WMS/OrderManagementFG/PrintExpressYd';
        ...
        //        return false;
        //    }
        //    window.location.href = '/WMS/OrderManagementFG/PrintExpressNike?id=' + id;
    ...
    $("#shipmentPrint").live('click', function () {
        ...
        layer.confirm('<font size="4">确认是否发送打印消息？</font>', {
            ...
            $.ajax({
                type: "Post",
                url: "/WMS/OrderManagementFG/SendS5ShipmentPrint",
                data: {
                    "IDs": ids
                },
                async: "false",
    ...
    $("#OutAgain").live('click', function () {
        ...
        $.ajax({
            type: "Post",
            url: "/WMS/OrderManagementFG/OutsWithDiff",
            data: {
                "ID": ID
            },
            async: "false",
...
//    }
//    else {
//        location.href = "/WMS/OrderManagementFG/Package/?ID=" + ID
//    }
//}
...
$("#printAllpod").live('click', function () {
    ...
    if (sql.length > 0) {
        if ($("#ProjectName").val().toString() === "NIKE") {
            ...
            $("#StatusbackID").val(sql.toString().substring(0, sql.toString().length - 1));
            window.location.href = "/WMS/OrderManagementFG/PrintAllPod_TH?ids=" + $("#StatusbackID").val();
        }
...
$("#btnPrintSumAllpod").live("click", function () {
    ...
    if (sql.length > 0) {
        if ($("#ProjectName").val().toString() == "NIKE") {
            ...
            $("#StatusbackID").val(sql.toString().substring(0, sql.toString().length - 1));
            window.locatprintAllpodion.href = "/WMS/OrderManagementFG/PrintSumAllPod?ids=" + $("#StatusbackID").val() + "&customerID=" + CustomerID + "&warehouseName=" + WarehouseName + "&SearchTime=" + time;
...
$("#outButton").live('click', function () {
    layer.confirm('<font size="4">确认是否批量出库？</font>', {
        ...
        //        $.ajax({
        //            type: "POST",
        //            url: "/WMS/OrderManagementFG/AcquireIDS",
        //            data: {
        //                "ids": IDD,
        //            },
        //            dataType: "json",
...
function Outs(ID, obj) {
    layer.confirm('<font size="4">确认是否出库？</font>', {
        ...
        //$.ajax({
        //    type: "POST",
        //    url: "/WMS/OrderManagementFG/CheckDiff",
        //    data: {
        //        "id": ID,
        //    },
        //    dataType: "json",

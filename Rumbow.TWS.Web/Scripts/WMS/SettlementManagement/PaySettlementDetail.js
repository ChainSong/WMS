...
function createCost() {
    //弹出层
    openPopup("addCostPop", true, 350, 200, null, 'addCost', true);
    $("#popupLayer_addCostPop")[0].style.top = "200px";
}
$("#addCostReturn").live('click', function () {
    closePopup();
});

$("#addCostOK").live('click', function () {

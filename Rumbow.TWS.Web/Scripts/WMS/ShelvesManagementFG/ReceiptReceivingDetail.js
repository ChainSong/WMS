$(document).ready(function () {
    ...
    //function selectList () {
    //    $.ajax({
    //        url: "/WMS/ShelvesManagementFG/asdasdadasd",
    //        type: "POST",
    //        data: {
    //            "RID": "740",
    //        },
    ...
    $("#SubmitOK").click(function () {
        ...
        layer.confirm('<font size="4">确认是否提交？</font>', {
            ...
            //}
            $.ajax({
                url: "/WMS/ShelvesManagementFG/StagingReceipt",
                dataType:"json",
                type: "POST",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.IsSuccess == true) {
                        //post('/WMS/ShelvesManagementFG/Index', { ShelvesModel: null, Action: '查询' });
                        //多层级页面跳转，准确跳回所在菜单主页
    ...
    $("#AddInventory").click(function () {
        ...
        layer.confirm('<font size="4">确认是否加入库存？</font>', {
            ...
            $.ajax({
                url: "/WMS/ShelvesManagementFG/AddshelvesAndInventory",
                type: "POST",
                data: {
                    "Jaonstr": str
                },
    ...
    $(".Area").on("blur", function () {
        var self = this;
        $.ajax({
            url: "/WMS/ShelvesManagementFG/ChangeArea",
            type: "POST",
            dataType: "json",
            data: {
    ...
    //            //$.ajax({
    //            //    url: "/WMS/ShelvesManagementFG/ChangeLocation",
    //            //    type: "POST",
    //            //    dataType: "json",
    //            //    data: {

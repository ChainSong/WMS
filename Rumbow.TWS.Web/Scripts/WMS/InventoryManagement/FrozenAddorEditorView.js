$(document).ready(function () {
    ...
    $('select[id=CustomerID]').live('change', function () {
        window.location.href = "/WMS/InventoryManagement/FrozenAddorEditorView/?ID=0&ViewType=1&customerID=" + $(this).val();
    });
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.indexOf("提交成功") >= 0) {
                                ...
                                //}
                                window.location.href = "/WMS/InventoryManagement/FrozenAddorEditorView/?ID=" + d + "&ViewType=0";
...
function addangian() {
    var customerID = $('#CustomerID').val();
    location.href = "/WMS/InventoryManagement/FrozenAddorEditorView/?ID=0" + "&customerID=" + customerID + "&ViewType=1"
}
//新增页面提交

$(document).ready(function () {
    ...
    $('select[id=CustomerID]').live('change', function () {
        window.location.href = "/WMS/InventoryManagement/MoveAddorEditorView/?ID=0&ViewType=1&customerID=" + $(this).val();
    });
                ...
                for (var i = 0; i < data.length; i++) {
                    if (data[i].SKU != "" && data[i].SKU != null) {
                        ...
                        for (var m = 0; m < skuSelect.length; m++) {
                            if (skuSelect[m].innerText == data[i].SKU + "|" + data[i].GoodsType) { flag = 1; }
                        }
                        if (flag == 0) {
                    ...
                    if (data[i].UPC != "" && data[i].UPC != null) {
                        ...
                        for (var m = 0; m < upcSelect.length; m++) {
                            if (upcSelect[m].innerText == data[i].UPC) { flag = 1; }
                        }
                        if (flag == 0) {
                    ...
                    if (data[i].BatchNumber != "" && data[i].BatchNumber != null) {
                        ...
                        for (var m = 0; m < batchnumberSelect.length; m++) {
                            if (batchnumberSelect[m].innerText == data[i].BatchNumber) { flag = 1; }
                        }
                        if (flag == 0) {
                    ...
                    if (data[i].BoxNumber != "" && data[i].BoxNumber != null) {
                        ...
                        for (var m = 0; m < boxnumberSelect.length; m++) {
                            if (boxnumberSelect[m].innerText == data[i].BoxNumber) { flag = 1; }
                        }
                        if (flag == 0) {
                    ...
                    if (data[i].Unit != "" && data[i].Unit != null) {
                        ...
                        for (var m = 0; m < UnitSelect.length; m++) {
                            if (UnitSelect[m].innerText == data[i].Unit) { flag = 1; }
                        }
                        if (flag == 0) {
                    ...
                    if (data[i].Specifications != "" && data[i].Specifications != null) {
                        ...
                        for (var m = 0; m < SpecificationsSelect.length; m++) {
                            if (SpecificationsSelect[m].innerText == data[i].Specifications) { flag = 1; }
                        }
                        if (flag == 0) {
...
function addNew() {
    ...
    if ($("#AdjustmentType").val() == "库存冻结单" || $("#hide").val() == "库存冻结单") {
        //$(".ToLocation").children("input").attr("readonly", "readonly");
        td12.append($("<input type='text'   name='ToLocationChild' id='ToLocation" + LineNumber + "' style='width:130px' readonly='true' class='form-control ToLocationChild'   value='' />"));
    }
    if ($("#AdjustmentType").val() == "库存调整单" || $("#hide").val() == "库存调整单") {
        //$(".ToLocation").children("input").attr("readonly", "readonly");
        td12.append($("<input type='text'   name='ToLocationChild' id='ToLocation" + LineNumber + "' style='width:130px'  readonly='true' class='form-control ToLocationChild'   value='' />"));
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.indexOf("提交成功") >= 0) {
                                ...
                                //}
                                window.location.href = "/WMS/InventoryManagement/MoveAddorEditorView/?ID=" + d + "&ViewType=0";
...
function addangian() {
    var customerID = $('#CustomerID').val();
    location.href = "/WMS/InventoryManagement/MoveAddorEditorView/?ID=0" + "&customerID=" + customerID + "&ViewType=1"
}
//新增页面提交

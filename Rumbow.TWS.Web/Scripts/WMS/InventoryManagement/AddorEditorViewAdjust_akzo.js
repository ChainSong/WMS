...
$(document).ready(function () {
    ...
    if ($('#HiddenViewType').val() == 2) {
        ...
        //    var locations = $(tr[i]).children(".FromLocation").children("input")[0].value;
        //    //tr[i].cells[1].children[0].value;
        //    var sku = $(tr[i]).children(".SKU").children("select")[0];

        //    var upc = $(tr[i]).children(".UPC").children("select")[0];
        //    //tr[i].cells[2].children[0];
        //    var batchsNum = $(tr[i]).children(".BatchNumber").children("select")[0];
        //    //tr[i].cells[3].children[0];
        //    var boxnumberNum = $(tr[i]).children(".BoxNumber").children("select")[0];
        //    //tr[i].cells[4].children[0];
        //    var batchSelected = $(tr[i]).children(".BatchNumber").children("select")[0];
        //    //tr[i].cells[3].children[0].innerText.trim();
        //    var boxnumberSelected = $(tr[i]).children(".BoxNumber").children("select").find('option:selected').val()[0];
        //        //tr[i].cells[4].children[0].innerText.trim();
        //    var skuSelected = $(tr[i]).children(".SKU").children("select").find('option:selected').val()[0];
        //        //tr[i].cells[2].children[0].innerText.trim();
        //    var opt1 = new Option("", "");
        //    var opt2 = new Option("", "");
        //    var opt3 = new Option("", "");
        //    batchsNum.options.add(opt1);
        //    boxnumberNum.options.add(opt2);
        //    sku.options.add(opt3);
        //    //batchsNum.id = "batchnumber" + ReturnLineNumber(i);
        //    //boxnumberNum.id = "boxnumber" + ReturnLineNumber(i);
        //    //sku.id = "sku" + ReturnLineNumber(i);
        //    $.ajax({
        //        url: "/WMS/InventoryManagement/GetInventoryskuList",
        //        type: "POST",
        //        dataType: "json",
        //        async: false,
        //        data: { CustomerID: $("#CustomerID").val(), location: locations, sku: "", upc: "", goodstype: "", batchnumber: "", boxnumber: "", warehouse: $("#WarehouseID option:selected")[0].innerText },
        ...
        //                    if (data[i].SKU + "-" + data[i].GoodsType != skuSelected) {
        //                        if (data[i].SKU != '') {
        //                            var flag = 0;
        //                            for (var m = 0; m < sku.length; m++) {
        //                                if (sku[m].innerText == data[i].SKU + "-" + data[i].GoodsType)
        //                                { flag = 1; }
        //                            }
        //                            if (flag == 0) {
        //                                var opt = new Option(data[i].SKU + "-" + data[i].GoodsType, data[i].SKU + "-" + data[i].GoodsType);
        //                                sku.options.add(opt);
        //                            }
        //                        }
        //                    }
        ...
        //    boxnumberNum.options.add(opt);
        //    var opt = new Option(skuSelected, skuSelected, true, true);
        //    sku.options.add(opt);
        ...
        //        if (sku[j].innerText == "" || sku[j].value == "") {
        //            sku.options.remove(j);
        //            skuLength--;
        //            j--;
        //        }
        //    }
    ...
    $('select[id=CustomerID]').live('change', function () {
        window.location.href = "/WMS/InventoryManagement/AddorEditorViewAdjust/?ID=0&ViewType=1&customerID=" + $(this).val();
    });
    ...
    $("#PrintOK").live('click', function () {
        ...
        //$(".ToLocation").live("keydown", function () {
        //    var LineNumber = $($(this).parent().parent()).children(".LineNumber").innerText;
        //    ///$(this).parent().prev().prev().prev().prev().prev().prev().prev().prev().prev().prev()[0].innerText;
        //    $('#ToLocation' + LineNumber).children("input")[0].autocomplete({
...
//    var LineNumber = $(this).parent().prev()[0].innerText;
//    var self = this;
//    $('#OldLocation' + LineNumber).autocomplete({

//        source: function (request, response) {
//            //request.term.length > 5
//            if (request.term.length > 5) {
//                $.ajax({
//                    url: "/WMS/InventoryManagement/GetLocationList",
//                    type: "POST",
...
//        select: function (event, ui)
//        {
//            $('#OldLocation' + LineNumber).val(ui.item.data.Text);
...
//                                }
//                                if (flag == 0) {
//                                    //if (skuSelect.length == 1) {
//                                    //    var opt0 = new Option(data[i].SKU + "-" + data[i].GoodsType, data[i].SKU + "-" + data[i].GoodsType, true, true);
//                                    //}
//                                    //else {
//                                    //    skuSelect[1].defaultSelected = false;
//                                    //    var opt0 = new Option(data[i].SKU + "-" + data[i].GoodsType, data[i].SKU + "-" + data[i].GoodsType);
//                                    //}
...
//                                }
//                                //if (UnitSelect.length > 1) {
//                                //    if (UnitSelect[0].value == "") {
//                                //        UnitSelect[1].defaultSelected = true;
//                                //    }
//                                //    else {
//                                //        UnitSelect[0].defaultSelected = true;
//                                //    }
//                                //}
//                            }
...
//                            //    b += "<option value=" + data[i].SKU + "-" + data[i].GoodsType + ">" + data[i].SKU + "-" + data[i].GoodsType + "</option>";
//                        }
//                        var objSelect = $($(self).parent().parent()).children(".ToGoodsType").children("select")[0];
...
//                        //b += "</select>";
//                        //if ($("#sku" + LineNumber).parent().length == 0) {
//                        //    $("#sku" + LineNumber).parent()[0].innerHTML = b;
//                        //} else {
//                        //    $("#sku" + LineNumber).parent()[0].innerHTML = b;
//                        //}
...
//                        //$.ajax({
//                        //    url: "/WMS/InventoryManagement/GetInventoryskuListByChange",
//                        //    type: "POST",
//                        //    dataType: "json",
//                        //    data: {
//                        //        location: ui.item.data.Text,
//                        //        sku: $(self).parent().parent().children(".SKU").children("select").find('option:selected').val().split('|')[0],
//                        //        //$("#sku" + LineNumber).val().substring(0, $("#sku" + LineNumber).val().indexOf('')),
//                        //        goodstype: $(self).parent().parent().children(".SKU").children("select").find('option:selected').val().split('|')[1],
//                        //        //$("#sku" + LineNumber).val().substring($("#sku" + LineNumber).val().indexOf('-') + 1),
//                        //        batchnumber: $(self).parent().parent().children(".BatchNumber").children("select").find('option:selected').val(),
//                        //        //$("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(),
//                        //        boxnumber: $(self).parent().parent().children(".BoxNumber").children("select").find('option:selected').val(),
//                        //        //$("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val(),
//                        //        warehouse: $("#WarehouseID option:selected")[0].innerText
//                        //    },
//                        //    success: function (data) {
//                        //        if (data.length > 0) {
...
//                        //            $($(self).parent().parent()).children(".FromQty").children("input")[0].value = data[0].qty;
//                        //            //$('#FromQty' + LineNumber).val(data[0].qty);
//                        //            var objSelect = $($(self).parent().parent()).children(".ToGoodsType").children("select")[0];
//                        //            //document.getElementById('ToGoodsType' + LineNumber);
//                        //            objSelect.length = 0;
//                        //            var opt1 = new Option("A品", "A品");
...
//                        //                $($(self).parent().parent()).children(".ToLocation").children("input")[0].value = ui.item.data.Text;
//                        //                //$('#ToLocation' + LineNumber).val(ui.item.data.Text);
//                        //                $('input[name=ToLocation').attr("readonly", "readonly");
//                        //                $($(self).parent().parent()).children(".ToGoodsType").children("select")[0].disabled = true;
//                        //                //document.getElementById('ToGoodsType' + LineNumber).disabled = true;
//                        //            } else {
//                        //                $($(self).parent().parent()).children(".ToLocation").children("input")[0].value = ui.item.data.Text;
//                        //                //$('#ToLocation' + LineNumber).val(ui.item.data.Text);
//                        //                $($(self).parent().parent()).children(".ToGoodsType").children("input")[0].disabled = false;
...
//                        //            //var opt3 = new Option("C品", "C品");
//                        //            //var opt4 = new Option("D品", "D品");
//                        //            //document.getElementById("ToGoodsType" + LineNumber).options.add(opt1);
//                        //            //document.getElementById("ToGoodsType" + LineNumber).options.add(opt2);
//                        //            //document.getElementById("ToGoodsType" + LineNumber).options.add(opt3);
//                        //            //document.getElementById("ToGoodsType" + LineNumber).options.add(opt4);
//                        //            //var objSelect = document.getElementById('ToGoodsType' + LineNumber);

//                        //            //$('#ToQty' + LineNumber).val("");
//                        //            $($(self).parent().parent()).children(".ToQty").children("input")[0].value = "";
//                        //            if ($("#AdjustmentType").val() == "库存调整单") {
//                        //                $($(self).parent().parent()).children(".ToLocation").children("input")[0].value = "";
//                        //                //$('#ToLocation' + LineNumber).val("");
//                        //                $('input[name=ToLocation').attr("readonly", "readonly");
//                        //                $($(self).parent().parent()).children(".ToGoodsType").children("input")[0].disabled = true;
//                        //                //document.getElementById('ToGoodsType' + LineNumber).disabled = true;
//                        //            } else {
//                        //                $($(self).parent().parent()).children(".ToGoodsType").children("input")[0].disabled = false;
//                        //                //document.getElementById('ToGoodsType' + LineNumber).disabled = false;
...
//                        //})
//                        //$("#sku" + LineNumber).change(function () {
//                        //    $.ajax({
//                        //        url: "/WMS/InventoryManagement/GetInventoryskuListByChange",
//                        //        type: "POST",
//                        //        dataType: "json",
//                        //        data: { location: ui.item.data.Text, sku: $('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-')), goodstype: $('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1), batchnumber: $("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: $("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val() },
//                        //        success: function (data) {
//                        //            if (data.length > 0) {
//                        //                if ($("#AdjustmentType").val() == "库存调整单") {
//                        //                    $('#ToLocation' + LineNumber).val(ui.item.data.Text);
...
//                        //                    }
//                        //                }
//                        //                $('#ToQty' + LineNumber).val(data[0].qty);
...
//                        //$("#batchnumber" + LineNumber).change(function () {
//                        //    $.ajax({
//                        //        url: "/WMS/InventoryManagement/GetInventoryskuListByChange",
//                        //        type: "POST",
//                        //        dataType: "json",
...
//                        //$("#boxnumber" + LineNumber).change(function () {
//                        //    $.ajax({
//                        //        url: "/WMS/InventoryManagement/GetInventoryskuListByChange",
//                        //        type: "POST",
//                        //        dataType: "json",
...
//$("select[name = 'sku']").live("change", function () {
//    var LineNumber = $(this).parent().prev().prev()[0].innerText.trim();
//    var self = this;
//    $.ajax({
//        url: "/WMS/InventoryManagement/GetInventoryskuList",
//        type: "POST",
//        dataType: "json",
//        data: {
//            location: $($(self).parent().parent()).children(".FromLocation").children("input")[0].value,
//            //$("#OldLocation" + LineNumber).val(),
//            sku: $(self).find('option:selected').val().split('|')[0],
//            upc: "",
//            //$($(self).parent().parent()).children(".SKU").children("select")[0].find('option:selected').val(),
//            //$('#sku' + LineNumber + ' option:selected').val(),
//            goodstype: $(self).find('option:selected').val().split('|')[1],
//            //$($(self).parent().parent()).children(".GoodsTyoe").children("select")[0].find('option:selected').val(),
//            //$('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1),
//            batchnumber: $($(self).parent().parent()).children(".BatchNumber").children("select").find('option:selected').val(),
//            boxnumber: $($(self).parent().parent()).children(".BoxNumber").children("select").find('option:selected').val(),
...
//        success: function (data) {
//            if (data.length > 0) {
//                var batchnumberSelect = $(self).parent().parent().children(".BatchNumber").children("input")[0];
//                var boxnumberSelect = $(self).parent().parent().children(".BoxNumber").children("input")[0];
//                var UnitSelect = $(self).parent().parent().children(".Unit").children("input")[0];//document.getElementById("Unit" + LineNumber);
//                var SpecificationsSelect = $(self).parent().parent().children(".Unit").children("input")[0];
//                batchnumberSelect.length = 0;
//                boxnumberSelect.length = 0;
//                UnitSelect.length = 0;
//                SpecificationsSelect.length = 0;
...
//                if ($("#AdjustmentType").val() == "库存调整单") {
//                    //var SpecificationsSelect = 
//                    $(self).parent().parent().children(".ToLocation").children("input")[0].value = $("#OldLocation" + LineNumber).val();
//                    //$('#ToLocation' + LineNumber).val($("#OldLocation" + LineNumber).val());
...
//                if (lens > 0) {
//                    for (var i = 0; i < lens; i++) {
//                        if (data[i].SKU == $(self).parent().parent().children(".SKU").children("select").find("option:selected").val().split("|")[0]
//                            //data[i].SKU == $('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-'))
//                            && data[i].BatchNumber == $(self).parent().parent().children(".BatchNumber").children("select").find("option:selected")[0].value
//                            //$("#batchnumber" + LineNumber).val() && 
//                           && data[i].BoxNumber == $(self).parent().parent().children(".BoxNumber").children("select").find("option:selected")[0].value
//                            && data[i].Unit == $(self).parent().parent().children(".Unit").children("select").find("option:selected")[0].value) {
//                            //$("#Unit" + LineNumber).val() && data[i].Specifications == $("#Specifications" + LineNumber).val()) {
//                            n += parseFloat(data[i].qty);
//                        }
//                    }
...
//$("select[name = 'batchnumber']").live("change", function () {
//    var LineNumber = $(this).parent().prev().prev().prev()[0].innerText.trim();
//    var self = this;
//    $.ajax({
//        url: "/WMS/InventoryManagement/GetInventoryskuList",
//        type: "POST",
//        dataType: "json",
//        data: {
//            location: $(self).parent().parent().children(".OldLocation").children("inoput")[0].value,
//            //$("#OldLocation" + LineNumber).val(),
//            sku: $(self).parent().parent().children(".SKU").children("inoput")[0].value.split("|")[0],
//            //$('#sku' + LineNumber + ' option:selected').val(),
//            goodstype: $(self).parent().parent().children(".SKU").children("inoput")[0].value.split("|")[1],
//            //$('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1),
//            batchnumber: $(self).parent().parent().children(".BatchNumber").children("select")[0].value,
//            //$("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: "",
//            warehouse: $("#WarehouseID option:selected")[0].innerText
//        },
//        success: function (data) {
//            if (data.length > 0) {
...
//                //document.getElementById("boxnumber" + LineNumber);
//                var UnitSelect = $(self).parent().parent().children(".Unit").children("select")[0];
//                //document.getElementById("Unit" + LineNumber);
//                var SpecificationsSelect = $(self).parent().parent().children(".Specifications").children("select")[0];
//                //document.getElementById("Specifications" + LineNumber);
//                boxnumberSelect.length = 0;
//                UnitSelect.length = 0;
...
//                }
//                if ($("#AdjustmentType").val() == "库存调整单") {
//                    $(self).parent().parent().children(".ToLocation").children("input")[0].value = $(self).parent().parent().children(".OldLocation").children("input")[0].value;
//                    //$('#ToLocation' + LineNumber).val($("#OldLocation" + LineNumber).val());
//                    $('input[name=ToLocation' + LineNumber + ']').attr("readonly", "readonly");
//                    $(self).parent().parent().children(".ToGoodsType").children("input")[0].disabled = true;
//                    //document.getElementById('ToGoodsType' + LineNumber).disabled = true;
...
//                    for (var i = 0; i < lens; i++) {
//                        if (data[i].SKU == $(self).parent().parent().children(".SKU").children("select").find("option:selected").val().split("|")[0]
//                            //$('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-'))
//                            && data[i].BatchNumber == $(self).parent().parent().children(".BatchNumber").children("select").find("option:selected").val()
//                            //$("#batchnumber" + LineNumber).val() 
//                            && data[i].BoxNumber == $(self).parent().parent().children(".BoxNumber").children("select").find("option:selected").val()
//                            //$("#boxnumber" + LineNumber).val()
//                            && data[i].Unit == $(self).parent().parent().children(".Unit").children("select").find("option:selected").val()
//                            && data[i].Specifications == $(self).parent().parent().children(".Specifications").children("select").find("option:selected").val()) {
//                            //$("#Specifications" + LineNumber).val()) {
//                            n += parseFloat(data[i].qty);
//                        }
//                    }
//                }
...
//                    //document.getElementById('ToGoodsType' + LineNumber).disabled = true;
//                } else {
//                    $(self).parent().parent().children(".ToGoodsType").children("select")[0].disabled = false;
//                    //document.getElementById('ToGoodsType' + LineNumber).disabled = false;
//                }
//                $(self).parent().parent().children(".FromQty").children("input")[0].value = "";
//                //$('#FromQty' + LineNumber).val("");
...
//                var objSelect = $(self).parent().parent().children(".ToGoodsType").children("select")[0];
//                //document.getElementById('ToGoodsType' + LineNumber);
//                $(self).parent().parent().children(".ToQty").children("input")[0];
//                //$('#ToQty' + LineNumber).val("");
//            }
//        }
//    })
...
//$("select[name = 'boxnumber']").live("change", function () {
//    var LineNumber = $(this).parent().prev().prev().prev().prev()[0].innerText.trim();
//    var self = this;
//    $.ajax({
//        url: "/WMS/InventoryManagement/GetInventoryskuList",
//        type: "POST",
//        dataType: "json",
//        data: {
//            location: $(self).parent().parent().children(".OldLocation").children("input")[0].value,
//            //$("#OldLocation" + LineNumber).val(), 
//            sku: $(self).parent().parent().children(".OldLocation").children("select").find("option:selected").val().split("|")[0],
//            goodstype: $(self).parent().parent().children(".OldLocation").children("select").find("option:selected").val().split("|")[1],
//            batchnumber: $(self).parent().parent().children(".BatchNumber").children("select").find("option:selected").val(),
//            //$("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), 
//            boxnumber: $(self).parent().parent().children(".BoxNumber").children("select").find("option:selected").val(),
//            //$("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val(), 
...
//                if (lens > 0) {
//                    for (var i = 0; i < lens; i++) {
//                        if (data[i].SKU == $(self).parent().parent().children(".SKU").children("select").find("option:selected").val()
//                            //$('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-'))
//                            && data[i].BatchNumber == $(self).parent().parent().children(".BatchNumber").children("select").find("option:selected").val()
//                            //$("#batchnumber" + LineNumber).val() 
//                            && data[i].BoxNumber == $(self).parent().parent().children(".BoxNumber").children("select").find("option:selected").val()
...
//                    }
//                }
//                $(self).parent().parent().children(".FromQty").children("select")[0].value = n;
//                $(self).parent().parent().children(".ToQty").children("select")[0].value = n;
//                //$('#FromQty' + LineNumber).val(n);
//                //$('#ToQty' + LineNumber).val(n);
...
//$("select[name = 'Unit']").live("change", function () {
//    var LineNumber = $(this).parent().prev().prev().prev().prev().prev()[0].innerText.trim();
...
//        type: "POST",
//        dataType: "json",
//        data: { location: $("#OldLocation" + LineNumber).val(), sku: $('#sku' + LineNumber + ' option:selected').val(), goodstype: $('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1), batchnumber: $("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: $("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val(), warehouse: $("#WarehouseID option:selected")[0].innerText, Unit: $("#Unit" + LineNumber).val(), Specifications: $("#Specifications" + LineNumber).val() },
//        success: function (data) {
//            if (data.length > 0) {
//                var SpecificationsSelect = document.getElementById("Specifications" + LineNumber);
//                SpecificationsSelect.length = 0;
...
//                if (lens > 0) {
//                    for (var i = 0; i < lens; i++) {
//                        if (data[i].SKU == $('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-'))
//                            && data[i].BatchNumber == $("#batchnumber" + LineNumber).val() && data[i].BoxNumber == $("#boxnumber" + LineNumber).val()
//                            && data[i].Unit == $("#Unit" + LineNumber).val() && data[i].Specifications == $("#Specifications" + LineNumber).val()) {
//                            n += parseFloat(data[i].qty);
//                        }
//                    }
//                }
...
//$("select[name = 'Specifications']").live("change", function () {
//    var LineNumber = $(this).parent().prev().prev().prev().prev().prev().prev()[0].innerText.trim();
//    $.ajax({
//        url: "/WMS/InventoryManagement/GetInventoryskuList",
//        type: "POST",
//        dataType: "json",
...
//function AddLocation(LineNumber, locations, AdjustSku, AdjustBatchNumber, AdjustBoxNumber, AdjustUnit, AdjustSpecifications) {
//    $('#OldLocation' + LineNumber).val(locations);
...
//        type: "POST",
//        dataType: "json",
//        data: { location: locations, sku: AdjustSku, goodstype: "A品", batchnumber: AdjustBatchNumber, boxnumber: AdjustBoxNumber, warehouse: $("#WarehouseID option:selected")[0].innerText, Unit: AdjustUnit, Specifications: AdjustSpecifications },
//        success: function (data) {
//            if (data == null || data == "") {
//                showMsg("该库位上面没有可用sku", "4000");
//                return;
...
//                var UnitSelect = document.getElementById("Unit" + LineNumber);
//                var SpecificationsSelect = document.getElementById("Specifications" + LineNumber);
//                var opts = new Option("请选择", "请选择",true,true);
//                var optba = new Option("请选择", "请选择", true, true);
//                var optbo = new Option("请选择", "请选择", true, true);
//                var optun = new Option("请选择", "请选择", true, true);
//                var optsp = new Option("请选择", "请选择", true, true);
//                skuSelect.options.add(opts);
//                batchnumberSelect.options.add(optba);
//                boxnumberSelect.options.add(optbo);
//                UnitSelect.options.add(optun);
...
//                        }
//                        if (flag == 0) {                                                      
//                            if (data[i].SKU + "-" + data[i].GoodsType == AdjustSku) {
//                                var opt0 = new Option(data[i].SKU + "-" + data[i].GoodsType, data[i].SKU + "-" + data[i].GoodsType, true, true);
//                            }
//                            else
//                            {
...
//                        }
//                        if (flag == 0) {
//                            if (data[i].BatchNumber == AdjustBatchNumber) {
//                                var opt1 = new Option(data[i].BatchNumber, data[i].BatchNumber, true, true);
//                            }
//                            else {
//                                var opt1 = new Option(data[i].BatchNumber, data[i].BatchNumber);
...
//                        }
//                        if (flag == 0) {
//                            if (data[i].BoxNumber == AdjustBoxNumber) {
//                                var opt2 = new Option(data[i].BoxNumber, data[i].BoxNumber, true, true);
//                            }
//                            else {
//                                var opt2 = new Option(data[i].BoxNumber, data[i].BoxNumber);
//                            }

//                            boxnumberSelect.options.add(opt2);
//                        }
//                    }
//                    if (data[i].Unit != "") {
//                        var flag = 0;
...
//                        }
//                        if (flag == 0) {
//                            if (data[i].Unit == AdjustUnit) {
//                                var opt3 = new Option(data[i].Unit, data[i].Unit, true, true);
//                            }
//                            else {
//                                var opt3 = new Option(data[i].Unit, data[i].Unit);
//                            }

//                            UnitSelect.options.add(opt3);
//                        }
//                    }
...
//                        }
//                        if (flag == 0) {
//                            if (data[i].Specifications == AdjustSpecifications) {
//                                var opt4 = new Option(data[i].Specifications, data[i].Specifications, true, true);
//                            }
//                            else {
//                                var opt4 = new Option(data[i].Specifications, data[i].Specifications);
//                            }

//                            SpecificationsSelect.options.add(opt4);
//                        }
//                    }
//                }
...
//                    type: "POST",
//                    dataType: "json",
//                    data: { location: locations, sku: AdjustSku.substring(0, AdjustSku.indexOf('-')), goodstype: AdjustSku.substring(AdjustSku.indexOf('-') + 1), batchnumber: $("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: $("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val(), warehouse: $("#WarehouseID option:selected")[0].innerText },
//                    success: function (data) {
//                        if (data.length > 0) {
//                            $('#FromGoodsType' + LineNumber).val(data[0].GoodsType);
//                            $('#GoodsName' + LineNumber).val(data[0].GoodsName);
...
//                //        type: "POST",
//                //        dataType: "json",
//                //        data: { location: locations, sku: $('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-')), goodstype: $('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1), batchnumber: $("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: $("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val() },
//                //        success: function (data) {
//                //            if (data.length > 0) {
//                //                if ($("#AdjustmentType").val() == "库存调整单") {
//                //                    $('#ToLocation' + LineNumber).val(locations);
...
//                //for (var i = 0; i < data.length; i++) {
//                //    if (data[i].SKU + "-" + data[i].GoodsType == AdjustSku) {
//                //        b += "<option value=" + data[i].SKU + "-" + data[i].GoodsType + " selected='selected'>" + data[i].SKU + "-" + data[i].GoodsType + "</option>";
//                //    }
//                //    else {
//                //        b += "<option value=" + data[i].SKU + "-" + data[i].GoodsType + ">" + data[i].SKU + "-" + data[i].GoodsType + "</option>";
//                //    }
...
//                //    type: "POST",
//                //    dataType: "json",
//                //    data: { location: locations, sku: $("#sku" + LineNumber).val().substring(0, $("#sku" + LineNumber).val().indexOf('-')), goodstype: $("#sku" + LineNumber).val().substring($("#sku" + LineNumber).val().indexOf('-') + 1), batchnumber: $("#batchnumber" + LineNumber).val() == null ? "" : $("#batchnumber" + LineNumber).val(), boxnumber: $("#boxnumber" + LineNumber).val() == null ? "" : $("#boxnumber" + LineNumber).val() },
//                //    success: function (data) {
//                //        $('#FromGoodsType' + LineNumber).val(data[0].GoodsType);
//                //        $('#GoodsName' + LineNumber).val(data[0].GoodsName);
//                //        $('#FromQty' + LineNumber).val(data[0].qty);
//                //        var q = " <select class='form-control' style='width:100px' id='ToGoodsType" + LineNumber + "'>"
//                //        q += "<option value=" + "A品" + ">" + "A品" + "</option>";
//                //        q += "<option value=" + "B品" + ">" + "B品" + "</option>";
//                //        q += "<option value=" + "C品" + ">" + "C品" + "</option>";
//                //        q += "<option value=" + "D品" + ">" + "D品" + "</option>";
//                //        q += "</select>";

//                //        if ($("#ToGoodsType" + LineNumber).parent().length == 0) {
//                //            $("#ToGoodsType" + LineNumber).parent()[0].innerHTML = q;
//                //        } else {
//                //            $("#ToGoodsType" + LineNumber).parent()[0].innerHTML = q;
//                //        }
//                //        var objSelect = document.getElementById('ToGoodsType' + LineNumber);
...
//                //        type: "POST",
//                //        dataType: "json",
//                //        data: { location: locations, sku: $('#sku' + LineNumber + ' option:selected').val().substring(0, $('#sku' + LineNumber + ' option:selected').val().indexOf('-')), goodstype: $('#sku' + LineNumber + ' option:selected').val().substring($('#sku' + LineNumber + ' option:selected').val().indexOf('-') + 1) },
//                //        success: function (data) {
//                //            if ($("#AdjustmentType").val() == "库存调整单") {
//                //                $('#ToLocation' + LineNumber).val(locations);
//                //                $('input[name=ToLocation' + LineNumber + ']').attr("readonly", "readonly");

$(document).ready(function () {
    ...
    $('#addButton').live('click', function () {
        window.location.href = "/WMS/MachiningManagement/WarhouseMachiningAddView/?ShowSubmit=" + $("#ShowSubmit").val();
    });
...
function Edit(ID, CustomerID, CustomerName,IDS,IDDS)
{
    window.location.href = "/WMS/MachiningManagement/WarhouseMachiningAddSave/?ID=" + ID + "&Flag=3" + "&CustomerID=" + CustomerID + "&CustomerName=" + CustomerName + "&IDS=" + IDS + "&ShowSubmit=" + $("#ShowSubmit").val();
}

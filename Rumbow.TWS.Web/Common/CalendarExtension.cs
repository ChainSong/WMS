...
namespace System.Web.Mvc
{
    ...
    {
        //public static MvcHtmlString CalendarMonthFor<TModel, TProperty>(this HtmlHelper<TModel> html, Expression<Func<TModel, TProperty>> expression, string className = null)
        //{
        ...
        //    return GenerateCalendarForMonth(html, name, className, nullableDateTime);
        //}
        //private static MvcHtmlString GenerateCalendarForMonth(this HtmlHelper html, string name, string className, DateTime? dateTime)
        //{
        //    var map = new ViewDataDictionary();
        //    map["DateTimeName"] = name;
        //    map["ClassName"] = className;
        //    return html.Partial("Month", dateTime, map);
        //}
        ...
        public static MvcHtmlString CalendarRangeDateTime(this HtmlHelper html, string name, string className = null, DateTime? startDateTime = null, DateTime? endDateTime = null)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(CalendarDateTime(html, "start_" + name, className, startDateTime).ToString());
            sb.Append("~");
            sb.Append(CalendarDateTime(html, "end_" + name, className, endDateTime).ToString());
            return MvcHtmlString.Create(sb.ToString());
        }

...
{
    public class SettledForJTYWLInRunbowProject_New: BaseSettled
    {
        public SettledForJTYWLInRunbowProject_New(int SettledType, long customerOrShipperID, bool IsGroupedPods, IEnumerable<long> PodIDs, long ProjectID, string Creator, long RelatedCustomerID)

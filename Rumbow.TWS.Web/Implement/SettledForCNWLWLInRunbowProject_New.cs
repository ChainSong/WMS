...
{
    public class SettledForCNWLWLInRunbowProject_New : BaseSettled
    {
        public SettledForCNWLWLInRunbowProject_New(int SettledType, long customerOrShipperID, bool IsGroupedPods, IEnumerable<long> PodIDs, long ProjectID, string Creator, long RelatedCustomerID)

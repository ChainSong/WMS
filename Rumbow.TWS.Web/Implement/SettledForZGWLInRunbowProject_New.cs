...
namespace Runbow.TWS.Web.Implement
{
    ...
    /// 成都akzo  紫光物流 
    /// </summary>
    public class SettledForZGWLInRunbowProject_New:BaseSettled
    {
        public SettledForZGWLInRunbowProject_New(int SettledType, long customerOrShipperID, bool IsGroupedPods, IEnumerable<long> PodIDs, long ProjectID, string Creator, long RelatedCustomerID)

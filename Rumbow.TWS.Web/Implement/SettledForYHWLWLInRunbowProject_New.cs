...
{
    public class SettledForYHWLWLInRunbowProject_New : BaseSettled
    {
        public SettledForYHWLWLInRunbowProject_New(int SettledType, long customerOrShipperID, bool IsGroupedPods, IEnumerable<long> PodIDs, long ProjectID, string Creator, long RelatedCustomerID)

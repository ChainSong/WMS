...
namespace Runbow.TWS.Biz
{
    public class BaseService
    {
        ...
        protected void LogCritical(string message)
        {
            ...
            {
                m_logWritter.Write(message, "General", 1, 2013, TraceEventType.Critical, "Runbow.TWS.Criticals");
            }
        }
        ...
        protected void LogError(string message)
        {
            if (m_logWritter.IsLoggingEnabled())
            {
                m_logWritter.Write(message, "General", 2, 2013, TraceEventType.Error, "Runbow.TWS.Errors");
            }
        }
        ...
        protected void LogWarning(string message)
        {
            if (m_logWritter.IsLoggingEnabled())
            {
                m_logWritter.Write(message, "General", 3, 2013, TraceEventType.Warning, "Runbow.TWS.Warnings");
            }
        }
        ...
        protected void LogInfo(string message)
        {
            if (m_logWritter.IsLoggingEnabled())
            {
                m_logWritter.Write(message, "General", 4, 2013, TraceEventType.Information, "Runbow.TWS.Information");
            }
        }
